...
export default /*final*/ class DecodedBitStreamParser {
    static /*final*/ TEXT_COMPACTION_MODE_LATCH = 900;
    static /*final*/ BYTE_COMPACTION_MODE_LATCH = 901;
    static /*final*/ NUMERIC_COMPACTION_MODE_LATCH = 902;
    static /*final*/ BYTE_COMPACTION_MODE_LATCH_6 = 924;
    static /*final*/ ECI_USER_DEFINED = 925;
    static /*final*/ ECI_GENERAL_PURPOSE = 926;
    static /*final*/ ECI_CHARSET = 927;
    static /*final*/ BEGIN_MACRO_PDF417_CONTROL_BLOCK = 928;
    static /*final*/ BEGIN_MACRO_PDF417_OPTIONAL_FIELD = 923;
    static /*final*/ MACRO_PDF417_TERMINATOR = 922;
    static /*final*/ MODE_SHIFT_TO_BYTE_COMPACTION_MODE = 913;
    static /*final*/ MAX_NUMERIC_CODEWORDS = 15;
    static /*final*/ MACRO_PDF417_OPTIONAL_FIELD_FILE_NAME = 0;
    static /*final*/ MACRO_PDF417_OPTIONAL_FIELD_SEGMENT_COUNT = 1;
    static /*final*/ MACRO_PDF417_OPTIONAL_FIELD_TIME_STAMP = 2;
    static /*final*/ MACRO_PDF417_OPTIONAL_FIELD_SENDER = 3;
    static /*final*/ MACRO_PDF417_OPTIONAL_FIELD_ADDRESSEE = 4;
    static /*final*/ MACRO_PDF417_OPTIONAL_FIELD_FILE_SIZE = 5;
    static /*final*/ MACRO_PDF417_OPTIONAL_FIELD_CHECKSUM = 6;
    static /*final*/ PL = 25;
    static /*final*/ LL = 27;
    static /*final*/ AS = 27;
    static /*final*/ ML = 28;
    ...
    static /*final*/ PS = 29;
    static /*final*/ PAL = 29;
    static /*final*/ PUNCT_CHARS = ';<>@[\\]_`~!\r\t,:\n-.$/"|*()?{}\'';
    static /*final*/ MIXED_CHARS = '0123456789&\r\t,:#-.$/+%*=^';
    /**
     * Table containing values for the exponent of 900.
     * This is used in the numeric compaction decode algorithm.
     */
    static /*final*/ EXP900 = getBigIntConstructor() ? getEXP900() : [];
    static /*final*/ NUMBER_OF_SEQUENCE_CODEWORDS = 2;
