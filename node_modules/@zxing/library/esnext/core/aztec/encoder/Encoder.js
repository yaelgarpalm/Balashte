...
export default /*public final*/ class Encoder {
    static /*final*/ DEFAULT_EC_PERCENT = 33; // default minimal percentage of error check words
    static /*final*/ DEFAULT_AZTEC_LAYERS = 0;
    static /*final*/ MAX_NB_BITS = 32;
    static /*final*/ MAX_NB_BITS_COMPACT = 4;
    static /*final*/ WORD_SIZE = Int32Array.from([
