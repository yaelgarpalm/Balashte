...
export default class GenericGF extends AbstractGenericGF {
    ...
    size;
    generatorBase;
    static AZTEC_DATA_12 = new GenericGF(0x1069, 4096, 1); // x^12 + x^6 + x^5 + x^3 + 1
    static AZTEC_DATA_10 = new GenericGF(0x409, 1024, 1); // x^10 + x^3 + 1
    static AZTEC_DATA_6 = new GenericGF(0x43, 64, 1); // x^6 + x + 1
    static AZTEC_PARAM = new GenericGF(0x13, 16, 1); // x^4 + x + 1
    static QR_CODE_FIELD_256 = new GenericGF(0x011d, 256, 0); // x^8 + x^4 + x^3 + x^2 + 1
    static DATA_MATRIX_FIELD_256 = new GenericGF(0x012d, 256, 1); // x^8 + x^5 + x^3 + x^2 + 1
