...
var DetectorResult_1 = __importDefault(require("../../common/DetectorResult"));
var GridSamplerInstance_1 = __importDefault(require("../../common/GridSamplerInstance"));
var PerspectiveTransform_1 = __importDefault(require("../../common/PerspectiveTransform"));
var DecodeHintType_1 = __importDefault(require("../../DecodeHintType"));
var NotFoundException_1 = __importDefault(require("../../NotFoundException"));
var ResultPoint_1 = __importDefault(require("../../ResultPoint"));
var MicroQRFinderPattern_1 = __importDefault(require("./MicroQRFinderPattern"));
/**
 ...
 *   6. Sample the grid.
 */
var MicroQRDetector = /** @class */ (function () {
    ...
    MicroQRDetector.prototype.detect = function (hints) {
        ...
        this.resultPointCallback = (hints != null)
            ? (_a = hints.get(DecodeHintType_1.default.NEED_RESULT_POINT_CALLBACK)) !== null && _a !== void 0 ? _a : null
            : null;
    ...
    MicroQRDetector.prototype.findFinderPattern = function (hints) {
        ...
        var tryHarder = hints != null && hints.get(DecodeHintType_1.default.TRY_HARDER) !== undefined;
        ...
        if (possibleCenters.length === 0) {
            throw new NotFoundException_1.default('No Micro QR finder pattern found.');
        }
        // Return the candidate with the highest count (most confirmations)
        possibleCenters.sort(function (a, b) { return b.getCount() - a.getCount(); });
    ...
    MicroQRDetector.prototype.handlePossibleCenter = function (stateCount, i, j, possibleCenters) {
        ...
        possibleCenters.push(new MicroQRFinderPattern_1.default(centerJ, centerI, estimatedModuleSize));
    ...
    MicroQRDetector.prototype.processFinderPattern = function (finderPattern) {
        ...
        if (moduleSize < 1.0) {
            throw new NotFoundException_1.default('Module size too small.');
        }
        var detected = this.determineDimension(fx, fy, moduleSize);
        if (detected === null) {
            throw new NotFoundException_1.default('Cannot determine Micro QR symbol dimension.');
        }
        ...
        var points = [
            new ResultPoint_1.default(fx, fy),
            new ResultPoint_1.default(topRightX, topRightY),
            new ResultPoint_1.default(bottomLeftX, bottomLeftY),
        ];
    ...
    MicroQRDetector.prototype.determineDimension = function (fx, fy, ms) {
        ...
        for (var orientation_1 = 0; orientation_1 < 4; orientation_1++) {
            ...
            if (dimH !== null && dimV !== null) {
                ...
                if (dim !== null) {
                    return { dim: dim, orientation: orientation_1 };
                }
            }
            else if (bestSingle === null && (dimH !== null || dimV !== null)) {
                var dim = this.snapDimension(dimH, dimV);
                if (dim !== null) {
                    bestSingle = { dim: dim, orientation: orientation_1 };
                }
            }
        }
    ...
    MicroQRDetector.createTransform = function (topLeftX, topLeftY, topRightX, topRightY, bottomLeftX, bottomLeftY, dimension) {
        ...
        return PerspectiveTransform_1.default.quadrilateralToQuadrilateral(3.5, 3.5, // source top-left (finder center in ideal grid)
        ...
        topLeftX, topLeftY, topRightX, topRightY, bottomLeftX, bottomLeftY, 
...
exports.default = MicroQRDetector;
