...
var AbstractRSSReader_1 = __importDefault(require("./AbstractRSSReader"));
...
var BarcodeFormat_1 = __importDefault(require("../../BarcodeFormat"));
var ResultPoint_1 = __importDefault(require("../../ResultPoint"));
var FinderPattern_1 = __importDefault(require("./FinderPattern"));
var DataCharacter_1 = __importDefault(require("./DataCharacter"));
var MathUtils_1 = __importDefault(require("../../common/detector/MathUtils"));
var RSSUtils_1 = __importDefault(require("./RSSUtils"));
var System_1 = __importDefault(require("../../util/System"));
var OneDReader_1 = __importDefault(require("../OneDReader"));
var RSS14Reader = /** @class */ (function (_super) {
    ...
    RSS14Reader.prototype.decodeDataCharacter = function (row, pattern, outsideChar) {
        ...
        if (outsideChar) {
            ...
            OneDReader_1.default.recordPattern(row, pattern.getStartEnd()[1], counters);
            // reverse it
